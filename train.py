...
import yaml
import setproctitle
from utils.log import set_config,EarlyStopping,data_reshaper,load_model
from utils.load_dataset import load_dataset,load_adj
from utils.util import TrainLogger,load_pickle
from utils.dataloader import DataLoader
from trainer import trainer
from models.SFADNet import SFADNet
...
# ========================== load dataset, adjacent matrix, node embeddings ====================== #
    ...
    t1   = time.time()
    adj_mx, adj_ori = load_adj(f'datasets/{dataset_name}/adj_mx_{dataset_name}_distance.pkl', config['data_args']['adj_type'])
    t2  = time.time()
...
# ============================= Model and Trainer ============================= #
    ...
    # init the model
    model   = SFADNet(**model_args).to(device)
